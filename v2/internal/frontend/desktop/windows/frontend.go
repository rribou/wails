...
import (
	...
	"github.com/rribou/wails/v2/internal/frontend/desktop/windows/win32"
	"github.com/rribou/wails/v2/internal/frontend/desktop/windows/winc"
	"github.com/rribou/wails/v2/internal/frontend/desktop/windows/winc/w32"
	wailsruntime "github.com/rribou/wails/v2/internal/frontend/runtime"
	"github.com/rribou/wails/v2/internal/logger"
	"github.com/rribou/wails/v2/internal/system/operatingsystem"
	"github.com/rribou/wails/v2/pkg/assetserver"
...
func (f *Frontend) Run(ctx context.Context) error {
	...
	mainWindow.OnSize().Bind(func(arg *winc.Event) {
		if f.frontendOptions.Frameless {
			...
			// depends on the content in the WebView, see https://github.com/rribou/wails/issues/1319
